...
namespace DTAClient.Domain.Singleplayer
{
    ...
    public class CampaignHandler
    {
        ...
        public List<Bonus> Bonuses { get; } = new List<Bonus>()
        {
            ...
            new Bonus("Heavy", "Heavy", "M_CRB14", "Your units and buildings have 12% more HP and deal 15% more damage per shot, but take 5% longer to reload. Your units are 12% slower.", "Thicker armor helps when you need to push through defensive formations.", new Difficulty() { Armor = 1.12, Firepower = 1.15, ROF = 0.8645, Groundspeed = 0.792 }),
            new Bonus("Valiant", "ArmorAndSpeed", "M_CRB16", "Your units and buildings have 10% more HP and your units are 12% faster. Your units and buildings are 10% more expensive.", "With more armor and speed, you would have had an easier time forcing the fight on the enemy. Might have been a good tradeoff despite more expensive production lines.", new Difficulty() { Armor = 1.1, Groundspeed = 1.008, Airspeed = 1.12, Cost = 1.1, }),
            new Bonus("Rapid Producer", "RapidProducer", "M_CRB17", "Your units and buildings build 20% faster. Your units and buildings are 12% more expensive.", "We found ourselves with plenty of Tiberium to harvest, enough to prioritize production speed over efficiency.", new Difficulty() { BuildTime=0.83, Cost=1.12 }),
        };
