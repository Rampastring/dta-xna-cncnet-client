...
namespace DTAClient.Domain.Multiplayer
{
    public class MapLoader
    {
        ...
        private const int MAP_CACHE_VERSION = 10;
        ...
        {
            string mpMapsIniHash = Utilities.CalculateSHA1ForFile(ProgramConstants.GamePath + ClientConfiguration.Instance.MPMapsIniPath);
            ...
            if (mapCacheIni.GetIntValue("Meta", "MapCacheVersion", 0) != MAP_CACHE_VERSION ||
                mapCacheIni.GetStringValue("MPMaps", "Hash", string.Empty) != mpMapsIniHash)
            {
            ...
            mapCacheIni.SetStringValue("MPMaps", "Hash", mpMapsIniHash);
            mapCacheIni.SetIntValue("Meta", "MapCacheVersion", MAP_CACHE_VERSION);
            mapCacheIni.MoveSectionToFirst("MPMaps");
