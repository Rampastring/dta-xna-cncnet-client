...
namespace DTAClient.DXGUI.Generic
{
    public class StatisticsWindow : XNAWindow
    {
        ...
        public override void Initialize()
        {
            ...
            btnClearStatistics.ClientRectangle = new Rectangle(UIDesignConstants.EMPTY_SPACE_SIDES_NEW, 486, UIDesignConstants.BUTTON_WIDTH_160, UIDesignConstants.BUTTON_HEIGHT);
