...
namespace DTAClient.Domain.Singleplayer
{
    ...
    public class CampaignHandler
    {
        ...
        public List<Bonus> Bonuses { get; } = new List<Bonus>()
        {
            ...
            new Bonus("Build Time", "BuildTime", "M_CR5", "Your units and buildings build 6% faster.", "Every second counts when setting up a defensive line or preparing to quickly rush your opponent.", new Difficulty() { BuildTime = 0.94 }),
