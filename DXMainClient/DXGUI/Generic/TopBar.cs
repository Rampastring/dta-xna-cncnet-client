...
namespace DTAClient.DXGUI.Generic
{
    ...
    public class TopBar : XNAPanel
    {
        ...
        public override void Initialize()
        {
            ...
            btnMainButton.ClientRectangle = new Rectangle(UIDesignConstants.EMPTY_SPACE_SIDES_NEW, 9, UIDesignConstants.BUTTON_WIDTH_160, UIDesignConstants.BUTTON_HEIGHT);
