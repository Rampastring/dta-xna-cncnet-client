...
namespace DTAClient.DXGUI.Multiplayer
{
    ...
    class LANGameCreationWindow : XNAWindow
    {
        ...
        public override void Initialize()
        {
            ...
            btnNewGame.ClientRectangle = new Rectangle(UIDesignConstants.EMPTY_SPACE_SIDES_NEW, 42, UIDesignConstants.BUTTON_WIDTH_133, UIDesignConstants.BUTTON_HEIGHT);
            ...
            btnLoadGame.ClientRectangle = new Rectangle(btnNewGame.Right + UIDesignConstants.EMPTY_SPACE_SIDES_NEW,
            ...
            btnCancel.ClientRectangle = new Rectangle(btnLoadGame.Right + UIDesignConstants.EMPTY_SPACE_SIDES_NEW,
                btnNewGame.Y, UIDesignConstants.BUTTON_WIDTH_133, UIDesignConstants.BUTTON_HEIGHT);
